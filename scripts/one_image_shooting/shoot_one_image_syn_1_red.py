...
if __name__ == '__main__':
    ...
    #load_rule_file('Synthinel_rules/international_city_1_vienna.cga', ce.isShape)
    exportImages(ce.toFSPath('images'), view, Tag='vienna_stye_syn_1')
    ...
    ###########################
    dynamic_attributes(adjust_list, camera_angle, light_angle, light_intensity, dynamic_range)
    load_rule_file('Synthinel_rules/international_city_1_vienna_labelling.cga', ce.isBlock)
    #exportGroundtruths(ce.toFSPath('images'), view, Tag='vienna_stye_syn_1')
